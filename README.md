...
- **Dependency security** — upgraded nodemailer (addressparser DoS, email routing fix), upgraded `@modelcontextprotocol/sdk` to v1.27.1, moved dev-only packages out of production dependencies ([PR #11](https://github.com/ArtyMcLabin/Gmail-MCP-Server/pull/11) by [@JF10R](https://github.com/JF10R))
